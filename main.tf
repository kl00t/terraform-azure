...
# Create a security rule (that allows for developer access)
...
# Create network security group association with subnet
...
resource "azurerm_linux_virtual_machine" "mtc-vm" {
  ...
  # Template for installing Docker on the virtual machine
